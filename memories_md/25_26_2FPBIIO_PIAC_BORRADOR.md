...
## FPBIIO 2r — Projecte Intermodular Aprenentatge Col·laboratiu
...
> 6. Aquest bloc d'instruccions **s'esborrarà automàticament** en compilar el PDF final.

- **Cicle**: FP Bàsica Informàtica d'Oficina

- **Curs**: 2r

- **Grup**: Grup únic

- **Mòdul**: Projecte Intermodular Aprenentatge Col·laboratiu (PIAC)

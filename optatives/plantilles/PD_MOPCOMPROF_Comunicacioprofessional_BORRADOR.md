...
# Programació didàctica: Mòdul optatiu Comunicació professional

## Dades identificatives i contextualització del mòdul

És un mòdul de 96 hores que s'imparteix en el cicle formatiu corresponent.

Té una correspondència en Crèdits de .



## Resultats d'Aprenentatge

Els **Resultats d'Aprenentatge** relatius al mòdul de Comunicació professional són:

|Codi| Resultat d'Aprenentatge |
|------|--------------------------|
| RA01 | Identifica les necessitats informatives de la comunitat, delimitant els processos d'informació i comunicació existents que faciliten la comunicació i difusió dels projectes i actuacions comunitàries. |
| RA02 | Identifica els diferents instruments de comunicació formal i informal existents en el territori d'actuació, analitzant-ne el potencial comunicatiu per delimitar-ne les possibles aplicacions. |
| RA03 | Dinamitza la posada en marxa de les diferents accions de comunicació, adaptant-les a la realitat del territori i de la comunitat per afavorir la transmissió i recepció de la informació relativa a les actuacions comunitàries. |
| RA04 | Promou i manté canals de comunicació en l'entorn d'intervenció, incorporant la perspectiva de gènere i la interseccionalitat. |
| RA05 | Avalua el grau d'utilitat de les accions i instruments de comunicació utilitzats, seguint els protocols establerts per l'equip de treball, per retroalimentar i millorar el procés de comunicació i difusió. |
...
## Esquema General de Comunicació professional

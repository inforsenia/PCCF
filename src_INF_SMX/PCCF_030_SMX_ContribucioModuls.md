...
# Contribució dels Mòduls a les Competències del Cicle SMX
...
| **e** Instal·lar i configurar xarxes locals cablejades, ... | X |   |   |   |   |   | X |   | X |   |
| **f** Instal·lar, configurar i mantenir serveis multiusu... | X |   |   |   |   | X | X |   | X | X |
| **g** Realitzar les proves funcionals en sistemes microi... |   |   |   | X | X | X |   |   | X |   |
| **h** Mantenir sistemes microinformàtics i xarxes locals... |   |   |   | X | X | X | X |   |   |   |
| **i** Executar procediments establerts de recuperació de... | X |   |   | X |   |   |   | X |   | X |
| **j** Elaborar documentació tècnica i administrativa del... | X |   |   | X |   | X |   | X | X | X |
| **k** Elaborar pressupostos de sistemes a mida complint ... |   |   |   | X | X | X |   |   |   |   |
| **l** Assessorar i assistir al client, derivant a un niv... |   |   |   | X | X | X | X | X |   |   |
| **m** Organitzar i desenvolupar el treball assignat mant... |   | X |   |   | X | X | X |   | X | X |
| **n** Mantenir un esperit constant d'innovació i actuali... |   |   | X |   | X | X | X | X |   | X |
...
| **ny** Utilitzar els mitjans de consulta disponibles, sel... |   |   |   |   |   |   |   |   |   |   |
| **o** Aplicar els protocols i normes de seguretat, quali... |   |   |   |   |   |   |   | X |   |   |
| **p** Complir amb els objectius de la producció, col·lab... |   |   |   |   |   | X | X | X |   |   |
| **q** Adaptar-se a diferents llocs de treball i noves si... |   | X |   |   |   |   | X |   |   | X |
| **r** Resoldre problemes i prendre decisions individuals... |   | X |   |   | X | X | X |   | X | X |
| **s** Exercir els seus drets i complir amb les obligacio... |   | X |   |   |   |   |   |   |   |   |
| **t** Gestionar la seua carrera professional, analitzant... |   | X | X |   |   |   |   | X |   |   |

...
# Programación didáctica: Módulo Fundamentos y configuración inicial de servicios en la nube.

## Datos identificativos y contextualización del módulo. 

Es un módulo de 130 horas que se imparte en el Curso de Especialización de Recursos y Servicios en la Nube.
...
Los **Resultados de Aprendizaje** relativos al módulo de Fundamentos y configuración inicial de servicios en la nube. son:

|Código| Resultado de Aprendizaje |
|------|--------------------------|
| RA01 |  Evalúa la localización de la infraestructura física de Tecnologías de la Información (TI), diferenciando entre su ubicación en instalaciones propias (on premise) y en la nube (cloud). |
| RA02 |  Escoge el modelo de implementación o despliegue de infraestructura de nube más apropiado para la organización en función de las necesidades de funcionalidad, seguridad, escalabilidad o costes, valorando las opciones disponibles en el mercado. |
| RA03 |  Reconoce los principales modelos de servicio en la arquitectura de nube en función de los recursos requeridos para alcanzar objetivos y necesidades a cubrir. |
| RA04 |  Prepara los interfaces de acceso y uso, configurándolos para acceder a los servicios de la plataforma en la nube: |
| RA05 |  Establece jerarquías de recursos para organizarlos, utilizando los niveles de organización disponibles según la entidad proveedora utilizada, siguiendo las prácticas recomendadas por la entidad proveedora. |
| RA06 |  Administra identidades y controles de acceso (en adelante, IAM), manteniendo la seguridad respecto a la autenticación y permisos y facilitando la realización de acciones de forma simple, rápida y eficiente para permitir la gestión de los recursos y servicios por personas y programas. |
| RA07 |  Reconoce el modelo de responsabilidad compartida de la entidad proveedora de nube, teniendo en cuenta la distribución de responsabilidades en relación con la seguridad digital y la conformidad y cómo se aplica en general a la operación en la nube, determinando cómo se aplica a su caso de uso específico. |
| RA08 |  Configura la facturación de los recursos desplegados para gestionar su pago y controlar y analizar los costes incurridos, siguiendo indicaciones contables e imputando los costes a los centros de gastos establecidos. |
| RA09 |  Configura un entorno para el posterior despliegue de recursos, administrando las cuotas de uso y habilitando las interfaces de programación de aplicaciones (Application Programming Interface, en adelante API) requeridas en su caso, según los servicios a utilizar y el uso o número de recursos a desplegar previsto. |
...
## Esquema General de Fundamentos y configuración inicial de servicios en la nube.

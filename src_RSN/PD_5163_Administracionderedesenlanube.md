...
# Programación didáctica: Módulo Administración de redes en la nube
...
Los **Resultados de Aprendizaje** relativos al módulo de Administración de redes en la nube son:

|Código| Resultado de Aprendizaje |
|------|--------------------------|
| RA01 |  Aplica procedimientos de despliegue de una infraestructura de red asociada a las aplicaciones de unos sistemas, configurando la privacidad, ciberseguridad y disponibilidad, para permitir la conectividad entre recursos de la nube y otras instalaciones propias (on premise) o en otras nubes. |
| RA02 |  Configura recursos de red, asignando parámetros de balanceo y escalado horizontal y vertical, desde orígenes externos o internos, en condiciones de ciberseguridad, direccionando y enrutando el tráfico a los recursos desplegados en la nube. |
| RA03 |  Administra redes privadas físicas y virtuales mediante herramientas de una entidad proveedora de nube y de empresas de dispositivos de conectividad, disponiendo de un entorno híbrido con conexiones privadas, directas y de alta capacidad entre los recursos locales y de nube. |
| RA04 |  Aplica procedimientos de configuración de la seguridad digital de los recursos, monitorizando sus conexiones, para registrar los accesos e identificar su potencial de riesgo en los sistemas. |
...
## Esquema General de Administración de redes en la nube

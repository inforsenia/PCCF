...
# Programación didáctica: Módulo Despliegue de servicios administrados en la nube

## Datos identificativos y contextualización del módulo. 

Es un módulo de 90 horas que se imparte en el Curso de Especialización de Recursos y Servicios en la Nube.
...
Los **Resultados de Aprendizaje** relativos al módulo de Despliegue de servicios administrados en la nube son:

|Código| Resultado de Aprendizaje |
|------|--------------------------|
| RA01 |  Aplica procedimientos de despliegue de recursos en la nube de manera automática a través de plantillas de ficheros para estandarizar el aprovisionamiento mediante infraestructura como código (IaC). |
| RA02 |  Aplica procedimientos de despliegue de servicios de mensajería asíncrona, optimizando la transmisión y el procesamiento de los flujos de datos que se intercambian entre múltiples fuentes y distribuirlos a múltiples receptores, monitorizando los resultados. |
| RA03 |  Aplica procedimientos de despliegue de ejecución de trabajos por lotes, para la ejecución de manera repetitiva de trabajos sin supervisión directa de las personas usuarias, monitorizando los resultados. |
| RA04 |  Aplica procedimientos de despliegue de soluciones de terceros, seleccionándolas desde el marketplace para automatizar el despliegue de paquetes de software. |
...
## Esquema General de Despliegue de servicios administrados en la nube

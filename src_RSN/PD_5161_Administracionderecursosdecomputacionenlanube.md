...
# Programación didáctica: Módulo Administración de recursos de computación en la nube

## Datos identificativos y contextualización del módulo. 

Es un módulo de 180 horas que se imparte en el Curso de Especialización de Recursos y Servicios en la Nube.

Tiene una correspondéncia en Créditos de -.
...
Los **Resultados de Aprendizaje** relativos al módulo de Administración de recursos de computación en la nube son:

|Código| Resultado de Aprendizaje |
|------|--------------------------|
| RA01 |   Utiliza técnicas de despliegue de instancias de computación y grupos de cómputo para usar los recursos, aplicando las características definidas previamente y proporcionando capacidades de autoescalado, para obtener un entorno de trabajo sobre el que configurar la capacidad de procesamiento según las necesidades. |
| RA02 |   Aplica técnicas de despliegue de contenedores, partiendo de imágenes almacenadas en un registro al efecto (hub), para ejecutar aplicaciones basadas en estos recursos según las necesidades. |
| RA03 |   Aplica técnicas de despliegue de la infraestructura de funciones como servicio, ejecutando componentes de aplicaciones basados en funciones desplegadas sobre cómputo. |
| RA04 |   Aplica procedimientos de preparación y de automatización del backup de infraestructuras de cómputo en plataforma de la entidad proveedora de nube, asegurando los datos y el estado de los recursos desplegados según las necesidades del proyecto. |
...
## Esquema General de Administración de recursos de computación en la nube

...
Las Unidades de Programación deben: 
...
Respecto a la evaluación, la persona tutora recabará el parecer de los instructores, que compartirá con los profesores del equipo docente.
...
Para superar un RA dualizado se debe **superar tanto la parte impartida en el centro como la realizada en la empresa en su caso**. Se considerará *superado cuando la nota de cada una de las partes sea igual o mayor a 5*.

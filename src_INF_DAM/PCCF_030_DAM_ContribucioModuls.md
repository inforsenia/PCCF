...
| Competència | 0483 | 0484 | 0485 | 0373 | 0487 | 0179 | 0486 | 0488 | 0489 | 0490 |
|-------------|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|
| **a** Configurar i explotar sistemes informàtics, adapta... | X |   |   |   |   | X |   |   |   |   |
| **b** Aplicar tècniques i procediments relacionats amb l... | X | X |   |   |   |   | X |   |   | X |
| **c** Gestionar bases de dades, interpretant el seu diss... |   | X |   |   |   |   | X |   |   |   |
| **d** Gestionar entorns de desenvolupament adaptant la s... |   |   |   |   | X |   |   | X | X |   |
| **e** Desenvolupar aplicacions multiplataforma amb accés... |   | X | X |   |   | X | X | X | X | X |
| **f** Desenvolupar aplicacions implementant un sistema c... |   |   |   |   | X | X | X | X |   |   |
| **g** Integrar continguts gràfics i components multimèdi... |   |   |   |   |   |   |   | X | X |   |
| **h** Desenvolupar interfícies gràfics d'usuari interact... |   |   |   | X | X |   |   | X | X |   |
| **i** Participar en el desenvolupament de jocs i aplicac... |   |   |   |   | X | X |   | X | X | X |
...
| **r** Realitzar plans de proves verificant el funcioname... |   |   |   |   |   |   | X | X |   |   |
| **s** Desplegar i distribuir aplicacions en diferents àm... |   |   |   |   |   |   |   | X | X |   |
...
| **r** Realitzar plans de proves verificant el funcioname... | X |   |   |   |   |   |   |
| **s** Desplegar i distribuir aplicacions en diferents àm... |   |   |   |   |   |   |   |
...
| Competència | 0483 | 0484 | 0485 | 0373 | 0487 | 0179 | 0486 | 0488 | 0489 | 0490 |
|-------------|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|
| **t** Establir vies eficaces de relació professional i c... | X | X | X | X |   |   | X | X | X | X |
| **u** Liderar situacions col·lectives que es puguen prod... | X |   |   |   |   |   |   |   |   |   |
| **v** Gestionar la seua carrera professional, analitzant... | X |   |   |   |   | X |   |   |   |   |
| **w** Mantenir l'esperit d'innovació i actualització en ... | X |   | X | X |   |   |   | X | X | X |
| **x** Crear i gestionar una petita empresa, realitzant u... | X |   |   |   |   |   |   |   |   |   |
| **y** Participar de forma activa en la vida econòmica, s... | X |   |   |   |   | X |   |   |   |   |

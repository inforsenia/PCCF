...
|f|Se han realizado operaciones de instala-ción/desinstalación de utilidades.|
...
|b|Se han utilizado herramientas gráficas para describir la organización de los archivos del sistema.|
...
|f|Se ha analizado la actividad del sistema a partir de las trazas generadas por el propio sistema.|
...
* Ejercicios realizados durante la Unidad:
  * Configuración de la Red en netplan.
  * Diseño de soluciones básicas de red.
  * Scripts básicos de diagnóstico y prueba.
  * Auditoría básica de procesos.
  * Reconfigurar el esquema de direccionamiento IP de la red interna de control para usar una única subred compartida.
  * Modificar los archivos Netplan del Supervisor y ambos PLCs para reflejar el nuevo direccionamiento.
  * Configurar el Supervisor como router/NAT entre la red interna de control y la red externa corporativa.
  * Actualizar Scripts para que funcionen con el nuevo esquema de red con IPs dinámicas.
  * Implementar mecanismos de configuración mediante variables o archivos de configuración.
  * Verificar que los PLCs pueden salir a Internet a través del Supervisor.
  * Documentar técnicamente el proceso de migración y justificar cada decisión.

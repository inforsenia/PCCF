...
- Arquitectura de un ordenador: Von Neumann. Bloques funcionales.
- La placa base: chipsets, buses, zócalos, factores de forma.
- Microprocesadores: marcas, características principales (frecuencia, núcleos, caché).
- Memorias RAM y de almacenamiento masivo (mecánicas, sólidas NVMe/SSD).





# UP02 : Ensambla componentes
...
| c    | Se ha determinado el sistema de apertura / cierre del chasis y los distintos sistemas de fijación para ensamblar-desensamblar los elementos del equipo. |
...
|  e   |  Se han ensamblado los módulos de memoria RAM, los discos fijos, las unidades de lectura / grabación en soportes de memoria auxiliar y otros componentes.  |
|  f   | Se han configurado parámetros básicos del conjunto accediendo a la configuración de la placa base.  |
|  g   |  Se han ejecutado utilidades de chequeo y diagnóstico para verificar las prestaciones del conjunto ensamblado.  |
...
- El taller de montaje: herramientas, útiles y medidas de seguridad (pulsera antiestática).
- Secuencia de montaje paso a paso: fuentes de alimentación, refrigeración, placas, procesadores, RAM y cableado.
...
# UP04 : Mantiene equipos informáticos
...
- Taller donde se provoca averias típicas.
- Taller donde se produce un sobrecalentamiento del procesador.
- Taller donde se reparan equipos.





# UP05 : Instala software desde dispositivos
...
- Se realizan instalaciones desde pendrives. Simples y de arranque dual.
- Se realizan múltiples particiones de disco.
- Se utiliza herramienta de clonación.
...
- Taller de modding, y participación en un concurso.
- Tareas de análisis para resolver problemas actuales.
...
|   d  | Se han asociado las características y prestaciones de los periféricos de captura de imágenes digitales, fijas y en movimiento con sus posibles aplicaciones. |
...
- Instalación y configuraciones básicas de impresoras por USB y en Red.
- Cambio de tóner y cartuchos de tinta.
- Limpieza de teclados y ratones.
- Diagnóstico de averias frecuentes para cada dispositivo.

# UP01 : Procesos, Redes y Software.
...
| RA04 |Administra de forma remota el sistema operativo en red valorando su importancia y aplicando criterios de seguridad.|20%|
| RA07 |Utiliza lenguajes de guiones en sistemas operativos, describiendo su aplicación y administrando servicios del sistema operativo.|30%|
...
| Sesiones   | Fechas                              |
|------------|-------------------------------------|
| 16 Sesiones | 08/09/2025 $\rightarrow$ 20/10/2025 |

# UP01 : Instalación de SO locales
...
| RA   | Resultado                                                                                    |
|------|----------------------------------------------------------------------------------------------|
| RA01 |  Instala sistemas operativos, analizando sus características e interpretando la documentación técnica.             |
...
- Tipos de Software. Distribuciones Linux.
- Instalaciones de Linux en Virtualbox. Aranque dual.
- Configuración de SO con bash.
- Scripting.
...
# UP02 : Configuración de SO locales
...
| RA   | Resultado                                                                                    |
|------|----------------------------------------------------------------------------------------------|
| RA02 |  Configura el software de base, analizando las necesidades de explotación del sistema informático.          |
...
# UP03 : Aseguramiento de la información
...
| RA   | Resultado                                                                                    |
|------|----------------------------------------------------------------------------------------------|
| RA03 | Asegura la información del sistema, describiendo los procedimientos y utilizando copias de seguridad y sistemas tolerantes a fallos.        |
...
- Gestión de particiones, y sistemas de ficheros.
- LVM y RAID.
...
# UP04 : Creación y gestión de dominios
...
| RA   | Resultado                                                                                    |
|------|----------------------------------------------------------------------------------------------|
| RA04 | Centraliza la información en servidores administrando estructuras de dominios y analizando sus ventajas.         |
...
- Creación de Dominio con Linux y Samba AD, en Ubuntu Server.
- Utilización de OpenLDAP, y Samba AD DC
- Colaboración con Fundamentos Hardware, para montar Proxmox, y ahí los dominios.




# UP05 : Administración de acceso a dominios
...
| RA   | Resultado                                                                                    |
|------|----------------------------------------------------------------------------------------------|
| RA05 | Administra el acceso a dominios analizando y respetando requerimientos de seguridad.     |
...
- Configuración de un cliente en el Dominio, para su unión. Usando OpenLDAP y Samba AD DC.
- Creación de GPOs usando los dominios de Samba AD.
- Utilización de sistemas de ficheros compartidos, así como de perfiles móviles.
...
# UP06 : Monitorización del sistema
...
| RA   | Resultado                                                                                    |
|------|----------------------------------------------------------------------------------------------|
| RA06 | Detecta problemas de rendimiento, monitorizando el sistema con las herramientas adecuadas y documentando el procedimiento.      |



### Criterios de Evaluación 

| RA06 | Criterios de Evaluación                              |
|------|------------------------------------------------------|
...
- Utilización de puesta en marcha de sistemas de monitorización, utilizando docker para ello.
- Puesta en marcha escenarios, con cargas de trabajo para que sean monitorizables y detectables.



# UP07 : Auditorias de recursos
...
| RA   | Resultado                                                                                    |
|------|----------------------------------------------------------------------------------------------|
| RA07 | Audita la utilización y acceso a recursos, identificando y respetando las necesidades de seguridad del sistema.       |



### Criterios de Evaluación 

| RA07 | Criterios de Evaluación                              |
|------|------------------------------------------------------|
...
- Investigación sobre escenarios con casos ocurridos, y que los alumnos deban saber si se hubiera producido una brecha, o un fallo.





# UP08 : Instalaciones desatendidas. Servidor de Actualizaciones
...
| RA   | Resultado                                                                                    |
|------|----------------------------------------------------------------------------------------------|
| RA08 | Implanta software específico con estructura cliente/servidor dando respuesta a los requisitos funcionales.       |
...
- Utilización de herramientas como Terraform para realizar instalaciones de sistemas de manera automatizada. 
- Utilización de Salt, para orquestar configuraciones automatizadas.

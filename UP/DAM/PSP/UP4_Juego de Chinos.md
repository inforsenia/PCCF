# PROGRAMACIÓN DIDÁCTICA: PROGRAMACIÓN DE SERVICIOS Y PROCESOS (0490)

## UP04: Juego de Chinos
### 1. Identificación
| Campo | Detalle |
| :--- | :--- |
| **Código** | UP04 |
...
*   **g)** Se han depurado y documentado los programas desarrollados.
*   **h)** Se han desarrollado aplicaciones que gestionen y utilicen procesos para la ejecución de varias tareas en paralelo.
...
**Competencias**
*   **Profesionales:** e), i), j), l), n).
*   **Ocupación:** t), u), v), w), y).

### 3. Organización
**Contenidos**
*   Programación concurrente y multihilo. Sincronización y comunicación
*   Prgramación distribuida. Sockets
*   Protocolos de comunicación. Servicios TCP

**Metodología**

Uso de metodologías activas centradas en el estudiante mediante la simulación de un entorno real, en este caso un juego multijugador. Los alumnos deben aportar una solución al problema planteado con las especificaciones indicadas y en el tiempo establecido.

**Secuencia (Fases)**
*   **F1:** Concurrencia y modelo Cliente-Servidor
*   **F2:** Sockets. Protocolo y estructura servidor
*   **F3:** Comunicación con el cliente 
*   **F4:** Depuración, pruebas y documentación

**Recursos**

Python, VirtualBox, sistema operativo Linux.

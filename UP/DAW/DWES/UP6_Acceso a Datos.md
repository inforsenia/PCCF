...
| **Duración** | **20 Horas** |
| **Temporalización** | Del **27/11/2026** al **11/12/2026** |
...
Uso de metodologías activas centradas en el estudiante mediante el uso de una Base de Datos Relacional en MySQL, ampliando la palicación web ejecutada en la UP5. Los alumnos deben aportar una solución al problema planteado con las especificaciones indicadas y en el tiempo establecido.

**Secuencia (Fases)**
*   **F1:** Diseño del Modelo de Datos
*   **F2:** PDO. Conexiones
*   **F3:** Repositorios. CRUD
*   **F4:** Persistencia alternativa (JSON)

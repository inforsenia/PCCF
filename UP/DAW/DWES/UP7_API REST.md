...
| **Duración** | **20 Horas** |
| **Temporalización** | Del **01/12/2025** al **21/01/2026** |
...
**Competencias**
*   **Profesionales:** c), d), f), h), j), k), l), m), n), ñ), q).
*   **Ocupación:** t), u), v), w), y).
...
*   Integración con BD
*   Diseño y creación de API REST propia
*   CRUD completo usando API REST
*   Apruitectura MVC en Servicios Web
...
Uso de metodologías activas centradas en el estudiante mediante el Aprendizaje Basado en Proyecto (ABP) consistente en el consumo de una API externa, la selección y adecuaciond e datos para introducirlos en la BD y la implemnetación de una API REST propia para poder realizar CRUD con los datos almacenados en la BD, realizando pruebas y documentando y verificando los endpoints. Los alumnos deben aportar una solución al problema planteado con las especificaciones indicadas y en el tiempo establecido.

**Secuencia (Fases)**
*   **F1:** Servicios Web
*   **F2:** REST API
*   **F3:** Consumo de API externa
*   **F4:** Diseño del modelo de datos para la API propia
*   **F5:** Creación de controladores API y rutas REST
*   **F6:** Implementación de CRUD completo con API REST
*   **F7:** Aplicación híbrida (API externa + BD + API propia)
*   **F8:** Documentación de la API
*   **F9:** Verificación y pruebas (Postman/REST Client)

**Recursos**

PHP, VS Code, Postman/REST CLient, sistema operativo Linux.
...
Se realizará el ejercicio final completo en el aula, con acceso a los apuntes de clase y sin acceso a Internet para comprobar la autonomía del alumnado a la hora de solucionar el ejercicio.

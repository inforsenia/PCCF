...
Uso de metodologías activas centradas en el estudiante mediante el Aprendizaje Basado en Proyecto (ABP) consistente en la implementación de una aplicación web completa usando Laravel. Los alumnos deben aportar una solución al problema planteado con las especificaciones indicadas y en el tiempo establecido.

**Secuencia (Fases)**
*   **F1:** Introducción al Framework LARAVEL
*   **F2:** Diseño y arquitectura del proyecto
*   **F3:** Implementación del backend con Laravel
*   **F4:** Implementación Frontennd con Blade
*   **F5:** API REST interna del proyecto
*   **F6:** Seguridad y autenticación
*   **F7:** Pruebas y verificación
*   **F8:** Documentación del proyecto
*   **F9:** Entrega y defensa del proyecto

**Recursos**

PHP, VS Code, Postman/REST CLient, Laravel sistema operativo Linux.
...
Se realizará el proyecto completo en el aula y se expondrá para su evaluación, debiendo el alumno aportar toda la documentación requerida así como justificar de forma técnica y profesional cualquier consulta o pregunta que se le realice del proyecto. No se valorará ningún proyecto hecho con IA donde el alumno no sepa o pueda defenderlo completa y correctamente.

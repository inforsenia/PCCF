...
| **Duración** | **18 Horas** |
| **Temporalización** | Del **09/11/2026** al **23/11/2026** |
...
*   Propiedades y métodos estáticos. Operador de resolución de ambito(::)
*   Herencia, interfaces y traits
*   Métodos mágicos
...
Uso de metodologías activas centradas en el estudiante mediante la implementación de una aplicación web con autenticación y operaciones en la que se utilice PHPOO y patrones de diseño (MVC) además de los aspectos vistos en las UP anteriores. Los alumnos deben aportar una solución al problema planteado con las especificaciones indicadas y en el tiempo establecido.

**Secuencia (Fases)**
*   **F1:** Herencia y abstracción
*   **F2:** Interfaces y traits
*   **F3:** Excepciones
*   **F4:** Patrones de diseño

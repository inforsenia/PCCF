...
## UP04: AUTENTICACIÓN DE USUARIOS Y GESTIÓN DE SESIONES
### 1. Identificación
| Campo | Detalle |
| :--- | :--- |
| **Código** | UP04 |
...
Uso de metodologías activas centradas en el estudiante mediante la implementación de un login real, ampliando el ejecutado en la UP3 con autenticación de usuarios, uso de cookies y sesiones, roles de usuario y seguridad mediante tokens. Los alumnos deben aportar una solución al problema planteado con las especificaciones indicadas y en el tiempo establecido.

**Secuencia (Fases)**
*   **F1:** Cookies y sesiones
*   **F2:** Formulario de Login
*   **F3:** Sesión del usuario
*   **F4:** Roles
*   **F5:** Seguridad con tokens

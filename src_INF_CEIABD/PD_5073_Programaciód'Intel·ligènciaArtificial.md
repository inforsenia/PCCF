...
# Programació didàctica: Mòdul Programació d'Intel·ligència Artificial

## Datos identificativos y contextualización del módulo. 

Es un módulo de 110 horas que se imparte en el Ciclo de Grado Superior de 
...
Los **Resultados de Aprendizaje** relativos al módulo de Programació d'Intel·ligència Artificial son:

|Código| Resultado de Aprendizaje |
|------|--------------------------|
| RA01 | Caracteritza llenguatges de programació valorant la seva idoneïtat en el desenvolupament d'Intel·ligència Artificial. |
| RA02 | Desenvolupa aplicacions d'Intel·ligència artificial utilitzant entorns de modelatge. |
| RA03 | Avalua les millores en els negocis integrant convergència tecnològica. |
| RA04 | Avalua models d'automatització industrial i de negoci relacionant-los amb els resultats esperats per les empreses. |
...
## Esquema General de Programació d'Intel·ligència Artificial

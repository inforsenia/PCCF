...
# Programació didàctica: Mòdul Big Data aplicat

## Datos identificativos y contextualización del módulo. 

Es un módulo de 75 horas que se imparte en el Ciclo de Grado Superior de 
Técnico en Desarrollo de Aplicaciones Multiplataforma.

Tiene una correspondéncia en Créditos de 8.



## Resultados de Aprendizaje

Los **Resultados de Aprendizaje** relativos al módulo de Big Data aplicat son:

|Código| Resultado de Aprendizaje |
|------|--------------------------|
| RA01 | Gestiona solucions a problemes proposats, utilitzant sistemes d'emmagatzematge i eines associades al centre de dades. |
| RA02 | Gestiona sistemes d'emmagatzematge i l'ampli ecosistema al seu voltant facilitant el processament de grans quantitats de dades sense fallades i de forma ràpida. |
| RA03 | Genera mecanismes d'integritat de les dades, comprovant el seu manteniment en els sistemes de fitxers distribuïts i valorant la sobrecàrrega que comporta en el tractament de les dades. |
| RA04 | Realitza el seguiment de la monitorització d'un sistema, assegurant la fiabilitat i estabilitat dels serveis que es proveeixen. |
| RA05 | Valida les tècniques de Big Data per transformar una gran quantitat de dades en informació significativa, facilitant la presa de decisions de negocis. |
| RA06 | Desenvolupa un projecte integrador que combine tècniques d'intel·ligència artificial i anàlisi de dades massives, aplicant models, algorismes i sistemes de Big Data per resoldre un problema real o simulat d'interès social, científic o empresarial, gestionant tot el cicle de vida del projecte des de l'obtenció de dades fins a la presentació de resultats. |
...
| h | Utilitzar solucions de Big Data per integrar sistemes d'explotació de dades. |
| i | Analitzar i avaluar solucions Big Data per a la seva implantació en les funcionalitats, processos i sistemes de decisions. |
...
| l | Aplicar tècniques Big Data per gestionar les dades de l'organització i obtenir coneixement a partir d'elles. |
...
| l | Gestionar de manera eficient les dades, la informació i la seva representació per transformar-les en coneixement. |
...
## Esquema General de Big Data aplicat

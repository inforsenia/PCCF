...
# Programació didàctica: Mòdul Sistemes de Big Data

## Datos identificativos y contextualización del módulo. 

Es un módulo de 55 horas que se imparte en el Ciclo de Grado Superior de 
Técnico en Desarrollo de Aplicaciones Multiplataforma.

Tiene una correspondéncia en Créditos de 6.



## Resultados de Aprendizaje

Los **Resultados de Aprendizaje** relativos al módulo de Sistemes de Big Data son:

|Código| Resultado de Aprendizaje |
|------|--------------------------|
| RA01 | Aplica tècniques d'anàlisi de dades que integren, processen i analitzen la informació, adaptant i implementant sistemes que les utilitzin. |
| RA02 | Configura quadres de comandament en diferents entorns computacionals usant tècniques d'anàlisi de dades. |
| RA03 | Gestiona i emmagatzema dades facilitant la cerca de respostes en grans conjunts de dades. |
| RA04 | Aplica eines per a la visualització de dades utilitzades en les solucions Big Data facilitant les tasques d'anàlisi i presentació de resultats. |
| RA05 | Desenvolupa un projecte integrador que combine tècniques d'intel·ligència artificial i anàlisi de dades massives, aplicant models, algorismes i sistemes de Big Data per resoldre un problema real o simulat d'interès social, científic o empresarial, gestionant tot el cicle de vida del projecte des de l'obtenció de dades fins a la presentació de resultats. |
...
## Esquema General de Sistemes de Big Data

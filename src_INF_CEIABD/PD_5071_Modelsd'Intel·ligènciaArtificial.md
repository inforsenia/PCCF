...
# Programació didàctica: Mòdul Models d'Intel·ligència Artificial

## Datos identificativos y contextualización del módulo. 

Es un módulo de 40 horas que se imparte en el Ciclo de Grado Superior de 
...
Los **Resultados de Aprendizaje** relativos al módulo de Models d'Intel·ligència Artificial son:

|Código| Resultado de Aprendizaje |
|------|--------------------------|
| RA01 | Caracteritza sistemes d'Intel·ligència Artificial relacionant-los amb la millora de l'eficiència operativa de les organitzacions i empreses. |
| RA02 | Utilitza models de sistemes d'Intel·ligència Artificial implementant sistemes de resolució de problemes. |
| RA03 | Relaciona el processament de llenguatge natural amb les seves aplicacions determinant el seu potencial i identificant les seves limitacions. |
| RA04 | Analitza sistemes robotitzats, avaluant opcions de disseny i implementació. |
| RA05 | Aplica sistemes experts avaluant la influència dels controladors intel·ligents en el comportament del sistema. |
| RA06 | Aplica principis legals i ètics al desenvolupament de la Intel·ligència Artificial integrant-los com a part del procés. |
...
| b | Desenvolupar i implementar sistemes d'Intel·ligència Artificial que facilitin la presa de decisions àgils dins d'un negoci gestionant i explotant dades massives. |
...
## Esquema General de Models d'Intel·ligència Artificial
